...
const projectSettingsI18n = {
  zh: {
    projectSettings: {
      ...
      extractorHybrid: "混合提取（推荐）", extractorHybridDesc: "MinerU版面分析 + 已配置 OCR Provider，文字识别和字体还原更精确",
  ...
  en: {
    projectSettings: {
      ...
      extractorHybrid: "Hybrid Extraction (Recommended)", extractorHybridDesc: "MinerU layout analysis + configured OCR provider for more accurate text and font recovery",
