...
Editable PPTX export supports two OCR backends:

### Baidu Accurate OCR

Apply for an [IAM API Key](https://console.bce.baidu.com/iam/#/iam/apikey/list) from Baidu Cloud, then configure:
...
Azure OCR can also return font family, color, weight, and italic metadata, which improves editable PPTX text style reconstruction.
