...
<Note>
  Choose the OCR provider in global settings. Azure Document Intelligence is recommended when font-family/style recovery matters most; Baidu remains available for the existing workflow. See [Configuration](/configuration#ocr-provider).
</Note>
